...
# -*- coding: UTF-8 -*-
"""
@Project ：SolUtil-master 
@File    ：dhs_N_1_flow.py
@Author  ：He Xing
@Date    ：2025/9/22 19:12 
"""
...
from Solverz import Var as SolVar, Param as SolParam, Eqn, Model, made_numerical, nr_method, module_printer, Sign, \
    heaviside, exp, Abs
from SolUtil.sysparser import load_N_1_hs
import numpy as np
import pandas as pd
from .hydraulic_mdl import HydraFlow

__all__ = ["DhsN_1Flow", "generate_dhs_module", "generate_temp_module"]
...
class DhsN_1Flow:
    ...
    def __init__(self,
        ...
        self.D = None
        self.Hset = None
        self.hc = load_N_1_hs(file, pipes_to_remove)
